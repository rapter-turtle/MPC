...
def acados_settings(Tf, N):
    ...
    # set cost
    Q = np.diag([ 0, 0, 1e-3, 1e-2, 1e-2, 1e-1, 1e-20, 1e-20 ])
    ...
    Qe = np.diag([ 0, 0, 1e-3, 1e-2, 1e-2, 1e-1, 1e-20, 1e-20])
    ...
    ocp.constraints.ubx = np.array([ 1000, 1000, 1000, 1,2, 3.141592, 800, 200])
