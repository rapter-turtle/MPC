...
def acados_settings(Tf, N):
    ...
    # set cost
    Q = np.diag([ 1e-2, 1e-2, 1e-8, 0, 1e-2, 1e-1, 1e-20, 1e-20 ])
    ...
    Qe = np.diag([ 1e-2, 1e-2, 1e-8, 0, 1e-2, 1e-1, 1e-20, 1e-20])
    ...
    # setting constraints
    ocp.constraints.lbx = np.array([-1000, -1000,-1000, -10000000, -10000000, -3.141592, -800, -200])
    ocp.constraints.ubx = np.array([ 1000, 1000, 1000, 10000000, 10000000, 3.141592, 800, 200])
