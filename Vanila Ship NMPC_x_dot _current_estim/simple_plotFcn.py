...
def plotTrackProj(simX, t):
    ...
    plt.xlim(left=-200,right=500)
    plt.ylabel('y[m]')
    plt.xlabel('x[m]')

    # Draw driven trajectory
    heatmap = plt.scatter(x,y, c=t, cmap=cm.rainbow, edgecolor='none', marker='o',linewidth=0.3, s= 1.5)
